...
const { clientSend, serverSend } = require("./messageTypes");
  ...
  ws.on("message", function (msg) {
    ...
    switch (msg?.messageType) {
      ...
      case clientSend.login:
        // login request will return userData if UUID exists
        try {
          if (msg?.data?.uuid) {
      ...
      case clientSend.dataUpdate:
        ...
        break;
      case clientSend.newConnection:
        break;
      default:
        errRes(ws, "Message Not Recognized");
        break;
    }
  });
});
